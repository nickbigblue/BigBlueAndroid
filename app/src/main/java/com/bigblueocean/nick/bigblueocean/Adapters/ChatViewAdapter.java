...
import com.bigblueocean.nick.bigblueocean.Fragments.ChatFragment.OnListFragmentInteractionListener;
...
public class ChatViewAdapter extends RecyclerView.Adapter<ChatViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.chat_fragment, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.chat_id);
            mContentView = (TextView) view.findViewById(R.id.chat_content);
        }
